    ...
    <section id="speakers" className="py-20 bg-[#4EB6B8]">
      <div className="container mx-auto px-4">
        ...
        {loading ? (
          ...
          <p className="text-center text-white text-lg">No speakers available right now.</p>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              ...
              >
                <Card className="text-center border-0 shadow-md hover:shadow-xl transition-shadow bg-white h-full rounded-2xl">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-xl font-bold text-nursing-text mb-2">{speaker.name}</h3>
                    <p className="text-nursing-primary font-medium mb-1">{speaker.type}</p>
                    <p className="text-nursing-text-light mb-4">{speaker.university}</p>
                    {speaker.bio && (
                      <p className="text-sm text-nursing-text-light leading-relaxed mb-4">
                        {speaker.bio}
                      </p>
                    )}
