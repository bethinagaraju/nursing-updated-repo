      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="mb-4 leading-relaxed">
              Empowering nursing professionals for the future of healthcare
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>
                Venue:{" "}
                {venue ? venue.conferenceVenue : "Loading..."}
              </p>
              <p>
                Accommodation:{" "}
                {venue ? venue.accommodationVenue : "Loading..."}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {dates ? (
                <>
                  <li>📅 Early Bird: {dates.earlyBird}</li>
                  <li>📅 Abstract Deadline: {dates.abstractDeadline}</li>
                  <li>📅 Standard Deadline: {dates.standardDeadline}</li>
                  <li>
                    📅 Conference: {dates.conference} - {dates.conferenceEndDate}
                  </li>
                  <li>📅 Registration Deadline: {dates.registrationDeadline}</li>
                </>
              ) : (
                <li>Loading dates...</li>
              )}
        ...
        <div className="border-t border-gray-600 pt-8">
          ...
          <div className="text-center text-sm text-gray-400">
            <p>
              &copy; 2026 Nursing Innovation & Leadership Summit. All rights
              reserved.
            </p>
            <p className="mt-2 space-x-4">
              <a
